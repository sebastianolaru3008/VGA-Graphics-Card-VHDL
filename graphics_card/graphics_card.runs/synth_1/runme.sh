...
HD_PWD='D:/Programming/Vivado/graphics_card/graphics_card.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log graphic_card.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source graphic_card.tcl
