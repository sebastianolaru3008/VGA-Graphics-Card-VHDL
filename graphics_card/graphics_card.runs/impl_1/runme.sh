...
HD_PWD='D:/Programming/Vivado/graphics_card/graphics_card.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log graphic_card.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source graphic_card.tcl -notrace
