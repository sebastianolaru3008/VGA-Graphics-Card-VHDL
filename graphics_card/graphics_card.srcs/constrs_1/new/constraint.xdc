...
set_property PACKAGE_PIN W5 [get_ports MASTER_CLOCK]							
	set_property IOSTANDARD LVCMOS33 [get_ports MASTER_CLOCK]
...
set_property PACKAGE_PIN V17 [get_ports {p_sel[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {p_sel[0]}]
set_property PACKAGE_PIN V16 [get_ports {p_sel[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {p_sel[1]}]
set_property PACKAGE_PIN W16 [get_ports {c_sel[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_sel[0]}]
set_property PACKAGE_PIN W17 [get_ports {c_sel[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {c_sel[1]}]
